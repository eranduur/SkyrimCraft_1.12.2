...
public class TileEntitySmelter extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.smelter";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockSmelter.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = SmelterRecipes.getInstance().getSmeltingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
			if(result.isEmpty()) 
				return false;
			else
			{
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = SmelterRecipes.getInstance().getSmeltingResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	/**
	 * Sets what can be burnt and how long it burns for
	 * @param fuel - the item being burned (basically anything wooden)
